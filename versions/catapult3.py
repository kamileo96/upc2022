...
def Shoot(r0, v0, o0):
    r, v, o = r0, v0, o0
    i=0
    while i<nsteps and r[2] >= R and r[1] <= target[1]*1.2:
        r, v, o = SimRK4(r, v, o)
        i+=1
...
ticks=[np.amin(results), np.amax(results)]
aspect=5
...
cbar = plt.colorbar(im, shrink=0.5, ticks=ticks)
cbar.set_label(r'd [m]', rotation=270)
plt.show()
